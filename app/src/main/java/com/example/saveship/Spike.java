...
//        spike[2]= BitmapFactory.decodeResource(context.getResources(), R.drawable.spike);
        Bitmap spikeBitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.spike);
        spike[0] = spikeBitmap.copy(spikeBitmap.getConfig(), true);
        spike[1] = spikeBitmap.copy(spikeBitmap.getConfig(), true);
        spike[2] = spikeBitmap.copy(spikeBitmap.getConfig(), true);
        random = new Random();
        resetPosition();
    }
